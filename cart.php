...
<div class="container" style="max-width:100%;" >
    <div id="grupoTarjeta" class="" style="padding: 1%;">
            <div id="Tarjeta" class="" style="width:90%; margin-left: 0%;border-style: solid;border-color: rgba(0, 0, 0, 0.24); margin-right: 5%;margin-left: 5%; padding: 2% 1%;border-radius: 3%;"  >

                  <div class="imagenBotones" style="width:30%; margin-top:20px; overflow: hidden; float:left;" >
                ...
                <div id ="buttons" class="width:10%; float:left" >
                  <a href="cart.html" class="btn btn-primary btn-lg active" role="button" aria-pressed="true" style="color: black; font-size: 2em;text-align: center;" >
                    -</a>
